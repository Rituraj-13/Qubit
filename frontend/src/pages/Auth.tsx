        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 text-slate-900 font-sans">
            <div className="w-full max-w-sm p-8 bg-white border border-slate-200 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                ...
                <div className="space-y-3">
                    <Button
                        variant="outline"
                        className="w-full py-6 text-base font-medium rounded-xl border-slate-200 bg-white hover:bg-slate-50 hover:text-slate-900 transition-all duration-200 shadow-sm flex items-center justify-center gap-3"
